...
const talleres = [
  ...
  "TAI CHI Y CHI KUNG",
  "USO DE NUEVAS TIC's",
  "USO DE NUEVAS TIC's AVANZADO",
];

const gestorias = [
  "GESTORIA ORIENTACION LEGAL",
  "GESTORIA DE TURISMO",
  "GESTORIA DE SALUD",
  "GESTORIA DE NUEVAS TECNOLOGIAS",
];
              ...
              {facilitadoresPorGestion.map((item) => {
                const growth =
                  item.gestion !== "2022"
                    ? Math.round(
                        ((item.facilitadores -
                          facilitadoresPorGestion[0].facilitadores) /
                          facilitadoresPorGestion[0].facilitadores) *
                          100,
                      )
                    : 0;
                ...
                return (
                  <div key={item.gestion} className="flex-1 text-center">
                    <div className="text-3xl font-bold text-[#FF8042]">
                      {item.facilitadores}
                    </div>
                    <div className="text-sm mt-1 bg-gray-100 py-1 rounded">
                      ...
                      {growth !== 0 && (
                        <span
                          className={`ml-1 ${growth > 0 ? "text-green-600" : "text-red-600"}`}
                        >
                          ({growth > 0 ? "+" : ""}
                          {growth}%)
                        </span>
