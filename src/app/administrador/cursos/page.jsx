          ...
          <h1 className="text-3xl font-bold flex items-center gap-3">
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth="2"
                d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.168 0.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5S19.832 5.477 21 6.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332 0.477-4.5 1.253"
              />
            </svg>
            Gestión de Cursos
          </h1>
          <p className="mt-1 text-sm text-slate-300">
            Administra el catálogo de talleres y programas de gestoría de la
            UMAM.
          </p>
        </div>
        <button
